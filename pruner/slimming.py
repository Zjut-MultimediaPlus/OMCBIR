        ...
        for b in self.blocks:
            if b.bnscale is not None:
                ...
                if isinstance(b.bnscale, list):
                    thres_perlayer[b] = [css_thresholding(scale, OT_DISCARD_PERCENT=discard_percent) for scale in b.bnscale]
                else:
                    thres_perlayer[b] = css_thresholding(b.bnscale, OT_DISCARD_PERCENT=discard_percent)
